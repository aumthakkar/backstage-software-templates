...
This repo demonstrates the creation and working of a Backstage Software template for a simple Python Flask app.
...
- Kubernetes Cluster including:
	...
	- A self-hosted Github runner on your machine using the instructions from the following link:
...
Doing the above, will allow to run this Backstage deployment from your browser.
...
- For instance if you have selected "py-app-1" as your Component name and "dev" as your environment, then the application name will formulate as "py-app-1-dev.test.com"
    - In order to access this application from your browser, as there is no DNS name configured for this app, you will have to first modify the "/etc/hosts" file of your computer to have an entry for this link mapped to the localhost IP address value as shown below:
...
- Finally, on your browser type py-app-1-dev.test.com/api/v1/info and you will get the Python Flask app display the desired app content.
